...
while cap.isOpened():
    ...
    print(model)
    """Below part is to draw the bounding boxes on the frame"""
    ...
    ann = prompt_process.text_prompt(object_to_track)
    ...
    #     bboxes=[[200, 200, 300, 300], [500, 500, 600, 600]]
    # )
